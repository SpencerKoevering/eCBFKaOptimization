function [originput,fval,exitflag,output] = doFminconwithKaChoice_det(objective_fun,Constraint_A,Constraint_b, options, car, fc, ft, bt, l_er, l_ef, l_fcr, l_fcf, l_ftr, l_ftf, l_btr, l_btf, afc, Bfc, aft, Bft, abt, Bbt, usefc, useft, usebt, rval, prev_alphafc, prev_alphaft, prev_alphabt)  
