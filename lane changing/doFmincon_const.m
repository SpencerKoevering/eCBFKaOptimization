function [originput,fval,exitflag,output] = doFmincon_const(objective_fun,Constraint_A,Constraint_b, options, car, fc, ft, bt, l_er, l_ef, l_fcr, l_fcf, l_ftr, l_ftf, l_btr, l_btf, afc, Bfc, aft, Bft, abt, Bbt, usefc, useft, usebt, ego_epsilon_mean, ego_epsilon_stdev, other_epsilon_mean, other_epsilon_stdev, confidence, rval, prev_alphafc, prev_alphaft, prev_alphabt, updateKa)  
    if(updateKa)
